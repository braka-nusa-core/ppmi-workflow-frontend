...
export function InvoiceEditClient({ invoice }: { invoice: InvoiceDocument }) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      >
        <Button variant="ghost" size="sm" icon={<X size={13} />} onClick={() => router.push(`/dashboard/invoice/${invoice.id}`)}>
          Cancel
        </Button>
